...
namespace BomberMan
{
    class SettingScreen : Screen
    {
        ...
        Audio audio;
        Font font;
        IntPtr fontLives, fontMap, fontTime;
        int lives { get; set; }
        ...
        public override void Show()
        {
            ...
            do
            {
                ...
                hardware.WriteText(fontMap, 325, 180);
                ...
                if (keyPressed == Hardware.KEY_UP && chosenOption > 1)
                {
                    audio.PlayWAV(0, 1, 0);
                    chosenOption--;
                    imgChosenOption.MoveTo(150, (short)(imgChosenOption.Y - 45));
                }
                ...
                // Option 3: change Map
                else if (chosenOption == 3 && keyPressed == Hardware.KEY_RIGHT)
                {
                    if (count < 2)
                    {
                        count++;
                ...
                else if (chosenOption == 3 && keyPressed == Hardware.KEY_LEFT)
                {
                    if (count > 0)
                    {
                        count--;
                ...
                // Option 4: Start Game
                else if (chosenOption == 4 && keyPressed == Hardware.KEY_ENTER)
                    game.Show();
